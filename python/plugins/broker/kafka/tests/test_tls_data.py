...
testparams = {
    'ssl_certfile_data': get_data(CLIENT_CERT_PATH),
    'ssl_keyfile_data': get_data(CLIENT_CERT_KEY_PATH),
}
@pytest.mark.skipif(
...
testparams = {
    'ssl_certfile_data': get_data(CLIENT_BAD_CERT_PATH),
    'ssl_keyfile_data': get_data(CLIENT_BAD_CERT_KEY_PATH),
}
@pytest.mark.skipif(
