...
/srv/kafka/bin/kafka-acls.sh --bootstrap-server localhost:9092 --add --allow-principal User:user02 --operation read --topic 'mss-test-003' --group '*'
...
/srv/kafka/bin/kafka-acls.sh --bootstrap-server localhost:9092 --add --allow-principal User:user03 --operation write --topic 'mss-test-003'
