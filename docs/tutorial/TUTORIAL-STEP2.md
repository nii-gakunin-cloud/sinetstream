...
SINETStreamで利用可能なメッセージングシステムは [Kafka](https://kafka.apache.org/) や [MQTT(Mosquitto)](https://mosquitto.org/) などがあります。
...
> サンプルプログラムconsumer.py 全体のコードは[GitHub](https://github.com/nii-gakunin-cloud/sinetstream/blob/main/python/sample/text/consumer.py)で確認できます。
...
> サンプルプログラムproducer.py 全体のコードは[GitHub](https://github.com/nii-gakunin-cloud/sinetstream/blob/main/python/sample/text/producer.py)で確認できます。
...
SINETStream v1.4 では非同期APIを利用することができます。
