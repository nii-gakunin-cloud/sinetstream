...
public class MqttBaseIO {
    ...
    MqttBaseIO(String service, Consistency consistency, String clientId, Map<String, ?> config,
        ...
        try {
            this.client = new MqttClient(getServerURI(), realClientId);
