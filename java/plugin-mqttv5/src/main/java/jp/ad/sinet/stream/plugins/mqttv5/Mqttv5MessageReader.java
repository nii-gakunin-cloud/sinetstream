...
@Log
public class Mqttv5MessageReader extends Mqttv5SyncBaseIO implements PluginMessageReader, Mqttv5Reader {
    ...
    private final BlockingQueue<SinetMqttv5Message> queue;

    Mqttv5MessageReader(ReaderParameters parameters) {
