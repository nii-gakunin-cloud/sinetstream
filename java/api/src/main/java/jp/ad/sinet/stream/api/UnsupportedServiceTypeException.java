...
public class UnsupportedServiceTypeException extends SinetStreamException {
    ...
    public UnsupportedServiceTypeException(String message) {
        super(message);
    }

    public UnsupportedServiceTypeException(String message, Throwable cause) {
        super(message, cause);
    }

    public UnsupportedServiceTypeException(Throwable cause) {
        super(cause);
    }
}
