...
public class IOStreamMessageProvider implements MessageWriterProvider, MessageReaderProvider {
    ...
    public PluginMessageWriter getWriter(WriterParameters params) {
        log.fine(() -> "IOStream getWriter: " + params.toString());
        return new IOStreamMessageWriter(params);
    }

    @Override
    public PluginMessageReader getReader(ReaderParameters params) {
        log.fine(() -> "IOStream getReader: " + params.toString());
        return new IOStreamMessageReader(params);
    }
